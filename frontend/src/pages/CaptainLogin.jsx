  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link
          to='/login'
          className='bg-[#d5622d] flex items-center justify-center text-white font-semibold mb-25 rounded-lg px-4 py-2 w-full text-lg placeholder:text-base'
...
//         <Link
//           to={"/login"}
//           className="bg-[#d1b00a] flex items-center justify-center text-white font-semibold mb-2 rounded px-4 
