...
//               className="bg-[#eeeeee]  w-1/2 rounded px-4 py-2 text-[14px]"
//             >
//               <option value="" disabled>
//                 Select Vehicle Type
//               </option>
...
//           <button className="bg-[#111] text-white font-semibold mt-4 mb-2 rounded px-4 py-2 w-full text-lg placeholder:text-base">
//             Create Captain Account
//           </button>
//           <p className="text-center">
